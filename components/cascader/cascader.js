...
exports.default = Component({
  ...
  data: {
    ...
    step: 0,
    dynamicWidth: 0,
    seqData: [{ title: '请选择', selected: true }]
  },
  methods: {
    ...
    nextStep: function nextStep(e, tbmode) {
      ...
      if (!this.data.newArray[this.data.step - 1][selectIndex].children) {
        ...
        this.data.seqData.splice(-1, 1, {
          [_this2.data.valueKey]: e.currentTarget.dataset.item[_this2.data.valueKey],
          [_this2.data.nameKey]: e.currentTarget.dataset.item[_this2.data.nameKey],
          selected: true
        });
        this.setData({
          newArray: this.data.newArray,
      ...
      if (!tbmode) {
        ...
        this.data.seqData[this.data.seqData.length - 1][_this2.data.nameKey] = "请选择";
      } else {
        this.data.seqData.splice(-1, 0, { [_this2.data.nameKey]: e.currentTarget.dataset.item[_this2.data.nameKey] });
        this.data.seqData.forEach(function (element) {
